  ...
  return (
    <main className="mx-auto w-full max-w-[720px] px-6 py-12">
      ...
      <Section title="Who else sees it">
        <p>
          Plans are generated by Anthropic&apos;s API, which receives the preferences you
          typed and the shortlist of venues, and does not use them to train models. Venue
          facts come from Google Places. Data is stored with Supabase. Nobody else.
        </p>
        <p>
